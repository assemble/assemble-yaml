 ...
 */
exports.extend = function(src, opts) {
  opts = opts || {};

  return glob.find(src, opts).map(function (path) {

    var context = exports.extract(path, opts).context;
    context = _.extend({}, opts.props, context);
    ...
    var content = exports.extract(path, opts).content;
    return {
      path: path,
      context: context,
      content: content
    ...
    return fencedYAML(obj.context, obj.content);
